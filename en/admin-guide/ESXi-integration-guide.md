As of version 12.03 Wakame-vdc is able to integrate with VMWare ESXi
...
MD5sum of ubuntu-lucid-esxi-64-flat.vmdk:
...
Turn on the virtual machine and use the VMWare remote console to install
Ubuntu on it.
