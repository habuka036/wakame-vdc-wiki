...
##### Size: 1595 bytes - wakame-vdc-hva-kvm-vmapp-config-12.03-20130422152723git7ffafa2.el6.i686.rpm  
...
wakame-vdc-hva-kvm-vmapp-config(x86-32) = 12.03-20130422152723git7ffafa2.el6
```  
&nbsp;  
&nbsp;  
&nbsp;  
